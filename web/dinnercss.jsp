    ...
    <div class="container">
     ...
     <div class="row">
       <h2><b>Student Menu</b></h2>
                ...
                PreparedStatement st=con.prepareStatement("select * from menu where Shift='Dinner'");
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                  <div class="form-group form-check">
                    ...
                    <button class="btn btn-primary  btn-block" type="submit" onclick="location.href='dinner.jsp'">Interested</button>
                    <button class="btn btn-primary  btn-block" type="submit" onclick="location.href='dinnercss.jsp'">Back</button>
