            ...
            <div class="row">
              ...
              <div class="col-md-3">
                  <div class="form-group form-check">
                    ...
                    <button class="btn btn-primary  btn-block" type="submit" onclick="location.href='breakfast.jsp'">Interested</button>
                    <button class="btn btn-primary  btn-block" type="submit" onclick="location.href='breakfastcss.jsp'">Back</button>
