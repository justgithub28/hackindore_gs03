...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
 ...
 <button class="btn btn-lg btn-primary " onclick="location.href='studentcss.jsp';" type="submit">Back</button>
         <button class="btn btn-lg btn-primary "  type="button">Notifications</button>
    ...
    <div class="container" >
     ...
     <%
                ...
                PreparedStatement st=con.prepareStatement("select * from notify ");
        ...
        for(int i=0;i<list1.size();i++)
        {
            ...
            <textarea class="form-control" id="message" rows="3" disabled="" style="margin-top: 30px;"><%=list1.get(i) %></textarea>
