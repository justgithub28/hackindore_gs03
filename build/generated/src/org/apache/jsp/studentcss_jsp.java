...
public final class studentcss_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <label class=\"form-check-label\" name=\"Interested\" for=\"exampleCheck1\">Interested</label>\r\n");
      out.write("                  </div>\r\n");
 ...
 st=con.prepareStatement("select * from menu where Shift='Lunch'");
              rs=st.executeQuery();
           while(rs.next())
        {
            list1.add(rs.getString(1));
 ...
 st=con.prepareStatement("select * from menu where Shift='Dinner'");
              rs=st.executeQuery();
           while(rs.next())
        {
            list1.add(rs.getString(1));
